...
def warg_push(
    ...
    res = client.publish_package_record(
        namespace, name, version, content_bytes, prev_id=prev_id
    )
...
def warg_pull(
    registry, warg_url, namespace, name, version=None, warg_token=None
) -> PackageDownload:
