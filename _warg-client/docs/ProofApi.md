...
with _warg_client.ApiClient(configuration) as api_client:
    ...
    api_instance = _warg_client.ProofApi(api_client)
    prove_consistency_request = _warg_client.ProveConsistencyRequest() # ProveConsistencyRequest |  (optional)
...
with _warg_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = _warg_client.ProofApi(api_client)
    prove_inclusion_request = _warg_client.ProveInclusionRequest() # ProveInclusionRequest |  (optional)
