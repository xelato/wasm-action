...
with _warg_client.ApiClient(configuration) as api_client:
    ...
    api_instance = _warg_client.FetchApi(api_client)
    fetch_logs_request = _warg_client.FetchLogsRequest() # FetchLogsRequest | 
...
with _warg_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = _warg_client.FetchApi(api_client)
    fetch_package_names_request = _warg_client.FetchPackageNamesRequest() # FetchPackageNamesRequest | 
