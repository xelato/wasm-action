...
from _warg_client.api_client import ApiClient
from _warg_client.api_response import ApiResponse
from _warg_client.exceptions import (  # noqa: F401
    ApiTypeError,
    ApiValueError
)
...
class ProofApi:
    ...
    def prove_consistency(self, prove_consistency_request : Optional[ProveConsistencyRequest] = None, **kwargs) -> ProveConsistencyResponse:  # noqa: E501
        ...
        :rtype: ProveConsistencyResponse
        """
    ...
    def prove_consistency_with_http_info(self, prove_consistency_request : Optional[ProveConsistencyRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ProveConsistencyResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method prove_consistency" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['prove_consistency_request'] is not None:
            _body_params = _params['prove_consistency_request']
        ...
        _response_types_map = {
            '200': "ProveConsistencyResponse",
            '404': "ProveConsistency404Response",
            '422': "BundleFailureError",
        }

        return self.api_client.call_api(
            '/proof/consistency', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def prove_inclusion_with_http_info(self, prove_inclusion_request : Optional[ProveInclusionRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ProveInclusionResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method prove_inclusion" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['prove_inclusion_request'] is not None:
            _body_params = _params['prove_inclusion_request']
        ...
        _response_types_map = {
            '200': "ProveInclusionResponse",
            '404': "ProveInclusion404Response",
            '422': "ProveInclusion422Response",
        }

        return self.api_client.call_api(
            '/proof/inclusion', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
