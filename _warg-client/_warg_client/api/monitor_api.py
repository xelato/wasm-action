...
class MonitorApi:
    ...
    def verify_checkpoint(self, signed_checkpoint : Optional[SignedCheckpoint] = None, **kwargs) -> CheckpointVerificationResponse:  # noqa: E501
        ...
        :rtype: CheckpointVerificationResponse
        """
    ...
    def verify_checkpoint_with_http_info(self, signed_checkpoint : Optional[SignedCheckpoint] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CheckpointVerificationResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method verify_checkpoint" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['signed_checkpoint'] is not None:
            _body_params = _params['signed_checkpoint']
        ...
        _response_types_map = {
            '200': "CheckpointVerificationResponse",
        }

        return self.api_client.call_api(
            '/verify/checkpoint', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
