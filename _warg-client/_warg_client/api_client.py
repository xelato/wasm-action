...
from _warg_client.configuration import Configuration
from _warg_client.api_response import ApiResponse
import _warg_client.models
from _warg_client import rest
from _warg_client.exceptions import ApiValueError, ApiException
...
class ApiClient:
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'xelato-wasm-action'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(_warg_client.models, klass)
